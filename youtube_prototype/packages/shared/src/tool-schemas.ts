...
export const TOOL_DEFINITIONS = [
  ...
  {
    name: 'update_theme',
    description: 'Change theme-level settings: mode (light/dark), accent color (hex), font scale, radius, and global videoCardDefaults (thumbnail aspect ratio, scale, title/channel weights, what to show on cards).',
