...
showcase/
  apps/
    web/                          # Next.js 15
    desktop/                      # v0.5 Electron sidecar (youtube-adapter)
  ...
  docs/                           # architecture, decisions, research, youtube-adapter
...
| Agent | Owns | Trigger |
|---|---|---|
| `research-runner` | `docs/research.md` (Day 1 only) | "Run the Day-1 research pass" |
...
| `youtube-adapter` *(Week 2)* | `apps/desktop/`, `lib/adapters/youtube.ts` | Real YouTube data via CDP |
...
- `docs/research.md` — frozen Day-1 research output.
- `docs/youtube-adapter.md` — Week-2 capture mechanics + breakage modes.
